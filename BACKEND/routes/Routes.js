...
router.get('/download-report', async (req, res) => {
    ...
    // Example dummy data – replace with real data from DB
    const data = [
      { metric: 'Employees', count: 40 },
      { metric: 'Applicants', count: 20 },
      { metric: 'Subscribers', count: 25 },
    ];
...
// Payslip route
// router.get('/api/payslip/:id', verifyToken, controller.generatePayslip);
router.get('/api/payslip/:id', verifyToken, controller.generatePayslip);
